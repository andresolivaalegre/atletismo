...
export class EntrenamientoComponent implements OnInit {
  ...
  igualarValores(i: any) {
    ...
    this.entreno.pista.multisalto.segundosTriple =
      pista.multisalto.segundosTriple;

    let gimnasio = JSON.parse(i.gimnasio);
    this.entreno.gimnasio.comentarios = gimnasio.comentarios;
    this.entreno.gimnasio.tipo.pectoral.descanso =
      gimnasio.tipo.pectoral.descanso;
    this.entreno.gimnasio.tipo.pectoral.kg = gimnasio.tipo.pectoral.kg;
    this.entreno.gimnasio.tipo.pectoral.repeticiones =
      gimnasio.tipo.pectoral.repeticiones;
    ...
    this.entreno.gimnasio.tipo.biceps.repeticiones =
      gimnasio.tipo.biceps.repeticiones;
    this.entreno.gimnasio.tipo.cuadriceps.descanso =
      gimnasio.tipo.cuadriceps.descanso;
    this.entreno.gimnasio.tipo.cuadriceps.kg = gimnasio.tipo.cuadriceps.kg;
    this.entreno.gimnasio.tipo.cuadriceps.repeticiones =
      gimnasio.tipo.cuadriceps.repeticiones;
  ...
  igualarValoresFormulario(i: any) {
    ...
    if (i.rodaje.km != null) this.entreno.rodaje.km = i.rodaje.km;
    if (i.rodaje.tiempo != null) this.entreno.rodaje.tiempo = i.rodaje.tiempo;
    ...
    if (i.pista.multisalto.segundosTriple != null)
      this.entreno.pista.multisalto.segundosTriple =
        i.pista.multisalto.segundosTriple;
    ...
    if (i.gimnasio.tipo.pectoral.descanso != null)
      this.entreno.gimnasio.tipo.pectoral.descanso =
        i.gimnasio.tipo.pectoral.descanso;
    ...
    if (i.gimnasio.tipo.pectoral.repeticiones != null)
      this.entreno.gimnasio.tipo.pectoral.repeticiones =
        i.gimnasio.tipo.pectoral.repeticiones;
    if (i.gimnasio.tipo.biceps.descanso != null)
      this.entreno.gimnasio.tipo.biceps.descanso =
        i.gimnasio.tipo.biceps.descanso;
    ...
    if (i.gimnasio.tipo.biceps.repeticiones != null)
      this.entreno.gimnasio.tipo.biceps.repeticiones =
        i.gimnasio.tipo.biceps.repeticiones;
    if (i.gimnasio.tipo.cuadriceps.descanso != null)
      this.entreno.gimnasio.tipo.cuadriceps.descanso =
        i.gimnasio.tipo.cuadriceps.descanso;
    ...
    if (i.gimnasio.tipo.cuadriceps.repeticiones != null)
      this.entreno.gimnasio.tipo.cuadriceps.repeticiones =
        i.gimnasio.tipo.cuadriceps.repeticiones;
  ...
  guardarinfo() {
    ...
    let gimnasio = JSON.stringify(aux.gimnasio);
      if (aux.id_entrenamiento == '' || aux.id_entrenamiento == null ) {
        this.apiService
          .postEntreno(aux.id_usuario, aux.fecha, rodaje, pista, gimnasio)
          .pipe(first())
          .subscribe((data) => {
              this.insertarOK = true;
            console.log(this.insertarOK);
          });
      } else {
        this.apiService
          .updateEntreno(aux.id_entrenamiento,aux.id_usuario,aux.fecha,rodaje,pista,gimnasio)
          .pipe(first())
          .subscribe((data) => {
